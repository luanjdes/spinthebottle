package com.imageandaudio.newapp07;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void girarGarrafa(View h){
        int novaDirecao = new Random().nextInt(1800);
        float eixoX = garrafa.getWidth()/2;
        float eixoY = garrafa.getHeight()/2;
        Animation girar =
                new RotateAnimation(ultimaDirecao, novaDirecao, eixoX, eixoY);
